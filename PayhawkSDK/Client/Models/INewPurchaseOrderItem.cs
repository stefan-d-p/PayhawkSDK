...
namespace PayhawkSDK.Client.Models
{
    ...
    /// </summary>
    public class INewPurchaseOrderItem : IParsable
    {
...
#nullable restore
        ...
        public PayhawkSDK.Client.Models.INewPurchaseOrderItem_units? Units { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="PayhawkSDK.Client.Models.INewPurchaseOrderItem"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static PayhawkSDK.Client.Models.INewPurchaseOrderItem CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PayhawkSDK.Client.Models.INewPurchaseOrderItem();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "units", n => { Units = n.GetEnumValue<PayhawkSDK.Client.Models.INewPurchaseOrderItem_units>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<PayhawkSDK.Client.Models.INewPurchaseOrderItem_units>("units", Units);
        }
    }
}
