...
{
    /// <summary>
    /// Response of multiple IPurchaseOrderItem objects
    /// </summary>
    public class IPurchaseOrderItemsResponse : IParsable
    {
        /// <summary>Array of IPurchaseOrderItem objects</summary>
...
#nullable restore
        ...
        public static PayhawkSDK.Client.Models.IPurchaseOrderItemsResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PayhawkSDK.Client.Models.IPurchaseOrderItemsResponse();
        }
        /// <summary>
