...
{
    /// <summary>
    /// New purchase order goods received note object
    /// </summary>
    public class INewGoodsReceivedNote : IParsable
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="PayhawkSDK.Client.Models.INewGoodsReceivedNote"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static PayhawkSDK.Client.Models.INewGoodsReceivedNote CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PayhawkSDK.Client.Models.INewGoodsReceivedNote();
        }
        /// <summary>
