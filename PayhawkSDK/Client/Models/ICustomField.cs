...
namespace PayhawkSDK.Client.Models
{
    ...
    /// Custom field object
    /// </summary>
    public class ICustomField : IParsable
    {
...
#nullable restore
        ...
        public static PayhawkSDK.Client.Models.ICustomField CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PayhawkSDK.Client.Models.ICustomField();
        }
        /// <summary>
