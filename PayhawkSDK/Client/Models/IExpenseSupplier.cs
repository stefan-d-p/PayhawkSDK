...
{
    /// <summary>
    /// Backwards compatible object containing all available information about the supplier for this expense
    /// </summary>
    public class IExpenseSupplier : IParsable
    {
...
#nullable restore
        ...
        public PayhawkSDK.Client.Models.IExpenseSupplier_status? Status { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="PayhawkSDK.Client.Models.IExpenseSupplier"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static PayhawkSDK.Client.Models.IExpenseSupplier CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PayhawkSDK.Client.Models.IExpenseSupplier();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "status", n => { Status = n.GetEnumValue<PayhawkSDK.Client.Models.IExpenseSupplier_status>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<PayhawkSDK.Client.Models.IExpenseSupplier_status>("status", Status);
